 ...
 * @author lj 1213
 */
public class Tela_Fornenedor extends javax.swing.JFrame {

    /**
     * Creates new form Tela_Fornenedor
     */
    public Tela_Fornenedor() {
        initComponents();
...
public void limpaCampo(){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Tela_Fornenedor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Tela_Fornenedor().setVisible(true);
            }
        });
    }
